...
folder_path = '/sdcard/Filename.txt'
try:
...
════════════════════════════════════════════════
\033[1;32m  • \033[1;37m Tool Owner :-  Termux Command
\033[1;32m  • \033[1;37m GitHub     :-  Termux command
\033[1;32m  • \033[1;37m Type       :-  Paid
\033[1;32m  • \033[1;37m Version    :-  {version}0.1")
os.system('clear')
#print("\033[1;32m [•]\033[1;37m Join My FaceBook ID...! \033[1;32mThnx");time.sleep(2);os.system('xdg-open https://www.facebook.com/profile.php?id=61552748889142&mibextid=ZbWKwL')
...
def Main_VENOM():
        ...
        if opt1 == "1": method()
            ...
            d=input(' [•] Choose : ')
            if d == '1':os.system('xdg-open https://api.whatsapp.com/send?phone=+93783361438/');Main_Termux()
            if d == '2':os.system('xdg-open https://www.facebook.com/profile.php?id=61552748889142&mibextid=ZbWKwL');Main_Termux()
...
def method():
    clear();print("\033[1;32m [•]\033[1;37m For Example : \033[1;32m/sdcard/Filename.txt");line()
    ...
    with tred(max_workers=30) as VENOM:
        ...
        print("\x1b[38;5;208m (!) \033[1;37mUse Flight Mode For Speed UP");print('\033[1;33m [•] \033[1;37mYour \033[1;32mOK\033[1;37m/\033[1;33mCP\033[1;37m IDs Save in \033[1;32m>\033[1;37m /sdcard/Termux');line()
        #line()
        for user in fo:
